...
const ProductCard = ({ product }) => {
  ...
  return (
    <div>
      <div
        className={`relative delay-150 w-180px lg:w-[270px] h-[205px] lg:h-[310px] bg-[#f8f8f8] background: url(${thumbnail})bg-cover bg-center transition-all duration-3000 ease-in-out transform`}
      ></div>
